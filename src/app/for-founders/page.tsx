    ...
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-4xl font-light leading-[1.15] text-charcoal-foreground sm:text-5xl lg:text-6xl">
              ...
              <em className="italic text-accent">can&apos;t keep up.</em> Stop hiring.{" "}
              <em className="italic text-accent">Start delegating.</em>
            </h1>
            <p className="mt-7 max-w-2xl text-base leading-relaxed text-charcoal-foreground/70 md:text-lg">
              Conciero is not a virtual assistant. Not a freelancer platform. It is a
              complete operating system — a dedicated operator, project manager, and
              specialist bench that plugs into your business and executes from day one.
            </p>
          ...
          <div className="grid grid-cols-2 gap-px md:grid-cols-4">
            {stats.map((s) => (
              <div key={s.label} className="px-4 py-8 text-center">
                <div className="font-serif text-3xl font-light text-accent md:text-4xl">
                  {s.num}
                </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
            <div className="rounded-xl border-l-4 border-muted-foreground/40 bg-secondary p-8">
              ...
              <p className="font-serif text-xl leading-relaxed text-foreground">
                You are growing fast but still doing everything yourself — inbox, hiring,
                ops, marketing, admin. Every hour spent on execution is an hour not spent
            ...
            <div className="rounded-xl border-l-4 border-accent bg-accent/10 p-8">
              ...
              <p className="font-serif text-xl leading-relaxed text-foreground">
                A Conciero team takes over your operational load — admin, outbound sales,
                marketing, web, recruiting — so you can focus on what actually moves the
                needle. Scale the output without scaling the headcount.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-secondary/40">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mb-12 text-center font-serif text-3xl font-normal text-foreground md:text-4xl">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <p className="font-serif text-2xl font-light italic leading-relaxed text-charcoal-foreground md:text-3xl">
              ...
              Not a freelancer. Not a VA. A complete operating system — AI-fluent, globally
              distributed, and ready to execute from day one. Try it free for a week before
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto grid max-w-6xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map(({ num, title, desc }) => (
              <div key={num} className="rounded-xl border border-border/60 bg-card p-6 shadow-card">
                <div className="font-serif text-3xl font-light text-accent">{num}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-5xl items-center gap-8 rounded-2xl border border-accent/40 bg-accent/10 p-8 md:grid-cols-2 md:p-12">
            <div>
              ...
              <h2 className="mb-3 font-serif text-3xl font-normal leading-tight text-foreground">
                One Week Free. No Credit Card. No Contract.
              </h2>
              <p className="text-sm leading-relaxed text-muted-foreground">
                Every engagement begins with a one-week free trial. Experience the team, the
                process, and the output — before any commitment is made.
              </p>
              <div className="mt-6">
                <Button asChild variant="accent" size="lg">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mb-7 text-charcoal-foreground/70">
              Book a 15-minute call and meet your operator. Start delegating this week.
            </p>
