  ...
  return (
    <form onSubmit={formik.handleSubmit} noValidate className="space-y-4">
      ...
      <div>
        ...
        >
          <option value="" disabled>Area of Expertise *</option>
      ...
      <button
        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 w-full bg-accent text-accent-foreground hover:bg-accent/90 font-semibold py-6"
        type="submit"
